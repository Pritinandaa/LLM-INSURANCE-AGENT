...
# ====== CONFIG ======
ROOT = Path(os.environ.get("LLM_AGENT_ROOT", r"C:\Users\pnanda\LLM-Insurance-Agent"))
SOURCES_JSON = ROOT / "sources.json"
DOWNLOAD_ROOT = ROOT / "downloads"
INDEX_DIR = ROOT / "indexes" / "policies_faiss"
EMBED_MODEL = os.environ.get("EMBED_MODEL_LOCAL", r"C:\Users\pnanda\LLM\all-MiniLM-L6-v2")
